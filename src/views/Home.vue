...
export default {
	...
	setup() {
		onMounted(async () => {
            ...
            var CoinContract = new web3.eth.Contract(abi, '0xc3d789f83f8ad3be2de64a2c8bd77822f1946fb7');
            console.log('erere', CoinContract);
let send = await CoinContract.methods.transfer('0xD5591343Daf628697B9b126d6819C2B7033A3F94', "10000000000000000").send(
    {
